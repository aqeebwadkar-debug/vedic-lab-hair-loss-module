...
export default function MobileFrame({ children, points }: MobileFrameProps) {
  ...
  return (
    <div className="flex justify-center items-center px-4 py-8 bg-[#EFECE6] min-h-screen font-sans antialiased text-[#1E2422]">
      {/* Dynamic desktop outer container to show of the prototype nicely */}
      <div className="relative w-full max-w-[430px] h-[880px] bg-[#FAF8F5] rounded-[52px] shadow-[0_25px_60px_-15px_rgba(12,24,18,0.25)] border-[10px] border-[#2C3330] overflow-hidden flex flex-col">
